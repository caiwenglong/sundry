...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'NaiveUI',
        desc: '基于 Vue 3 的高质量 UI 组件库',
        link: 'https://www.naiveui.com/'
      },
      {
        icon: '',
        title: 'Arco Design Vue',
        desc: '企业级设计体系 Arco 的 Vue 实现',
        link: 'https://arco.design/docs/vue/introduce'
      },
      {
        icon: 'https://www.antdv.com/assets/logo.1ef800a8.svg',
        title: 'Ant Design Vue',
        desc: '基于 Vue 的企业级 UI 组件库',
    ...
    items: [
      {
        ...
        title: 'Typed.js',
        desc: '打字动画',
        link: 'http://mattboldt.github.io/typed.js/'
      },
      {
        icon: 'https://animista.net/images/animista-logo-small.svg',
        title: 'Animista',
        desc: 'CSS动态效果库',
        link: 'https://animista.net/'
      },
      {
        icon: 'https://adajuly.github.io/AniX/static/media/logos.d3ab7b8c.png',
        title: 'AniX',
        desc: 'ANIX是一个轻量级且易于使用的动画库，在现代浏览器发挥优良的性能和良好的兼容性。它采用了原生的CSS属性的过渡，不是JS模拟动画，因此性能更好。并且可以使用硬件加速。ANIX不到3K的大小',
        link: 'https://github.com/drawcall/AniX'
      },
      {
        icon: '',
        title: 'AOS',
